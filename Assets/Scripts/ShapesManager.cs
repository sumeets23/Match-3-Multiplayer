...
public class ShapesManager : MonoBehaviour
{
    ...
    // Parent transform for all spawned prefabs (candies, bonuses, explosions)
    ...
    private void InstantiateAndPlaceNewCandy(int row, int column, GameObject newCandy)
    {
        GameObject go = Instantiate(newCandy,
            ...
            as GameObject;
        if (spawnedParent != null) go.transform.SetParent(spawnedParent, worldPositionStays: true);
    ...
    private IEnumerator FindMatchesAndCollapse(RaycastHit2D hit2)
    {
        ...
        {
            // ✅ Give fixed score of 10 for each match sequence
            IncreaseScore(10);
    ...
    private void CreateBonus(Shape hitGoCache)
    {
        GameObject Bonus = Instantiate(GetBonusFromType(hitGoCache.Type), BottomRight
            ...
            as GameObject;
        if (spawnedParent != null) Bonus.transform.SetParent(spawnedParent, worldPositionStays: true);
        ...
        foreach (int column in columnsWithMissingCandy)
        {
            ...
            foreach (var item in emptyItems)
            {
                ...
                GameObject newCandy = Instantiate(go, SpawnPositions[column], Quaternion.identity)
                    as GameObject;
                if (spawnedParent != null) newCandy.transform.SetParent(spawnedParent, worldPositionStays: true);
    ...
    private void RemoveFromScene(GameObject item)
    {
        ...
        if (spawnedParent != null) newExplosion.transform.SetParent(spawnedParent, worldPositionStays: true);
    ...
    public void IncreaseScore(int amount)
    {
        ...
        if (playerNetwork != null && playerNetwork.Object != null && playerNetwork.Object.HasInputAuthority)
            playerNetwork.AddScore(score);
    }
